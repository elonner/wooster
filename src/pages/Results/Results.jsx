  ...
  useEffect(() => {
    if (moreInfo) {
      ...
      descriptionRef.current.style.height = `${
        tableRef.current?.clientHeight + 2
      }px`;
    } else {
    ...
    <div className="results">
      {data && resultData.id ? (
        <>
          {sentResultId ? (
            showResultsLink ? (
              <p
                ...
                className="switchLink my-results"
              >
                my results
              </p>
            ) : (
            ...
            <i
              onClick={share}
              className="fa-solid fa-share-from-square fa-2x"
            ></i>
          )}
          ...
          <div className="info">
            ...
            >
              ...
              <i
                className={`fa-solid plus ${moreInfo ? "fa-minus" : "fa-plus"}`}
              ></i>
            </div>
          </div>
          {sentResultId ? (
            <>
              ...
              <div className="btn-container">
                <button
                  onClick={() =>
                    navigate("/survey", { state: { id: sentResultId } })
                  }
                  className="sbmt-btn"
                >
                  Take Quiz!
            ...
            <>
              <p className="switchForms take-again">
                Make a mistake? &nbsp;
                <span
              ...
              <div className="btn-container">
                <button onClick={share} className="sbmt-btn">
                  Share Your Results!
                </button>
              </div>
            </>
        ...
        <>
          <p>fetching data</p>
          <p>
            if this is taking too long click <span onClick={logOut}>here</span>
          </p>
        </>
      )}
    </div>
